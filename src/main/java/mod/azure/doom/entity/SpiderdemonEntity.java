...
public class SpiderdemonEntity extends DemonEntity implements IAnimatable {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(4,
				new RangedStrafeAttackGoal(this,
						new SpiderdemonEntity.FireballAttack(this).setProjectileOriginOffset(0.8, 0.8, 0.8), 1.0D, 50,
						30, 15, 15F).setMultiShot(5, 1));
	...
	public class FireballAttack extends AbstractRangedAttack {
		...
		@Override
		public DamagingProjectileEntity getProjectile(World world, double d2, double d3, double d4) {
