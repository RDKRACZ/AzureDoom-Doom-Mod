...
public class ArchvileEntity extends DemonEntity {
	...
	private boolean teleportToEntity(Entity p_70816_1_) {
		Vec3d vector3d = new Vec3d(this.getPosX() - p_70816_1_.getPosX(),
	...
	private boolean shouldAttackPlayer(PlayerEntity player) {
		Vec3d vector3d = player.getLook(1.0F).normalize();
		Vec3d vector3d1 = new Vec3d(this.getPosX() - player.getPosX(), this.getPosYEye() - player.getPosYEye(),
