...
public class ShotgunguyModel<T extends ShotgunguyEntity> extends BipedModel<T> {
	...
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
		...
		this.bipedRightArm_flat.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 0.2F * limbSwingAmount / 1.0F;
