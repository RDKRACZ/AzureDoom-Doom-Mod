...
public class HookRender extends EntityRenderer<HookEntity> {
	private static final ResourceLocation TEXTURE_LOCATION = new ResourceLocation("textures/entity/fishing_hook.png");
	private static final RenderType RENDER_TYPE = RenderType.entityCutout(TEXTURE_LOCATION);

	public HookRender(EntityRendererManager p_i46175_1_) {
		super(p_i46175_1_);
	}
	...
	public void render(HookEntity p_225623_1_, float p_225623_2_, float p_225623_3_, MatrixStack p_225623_4_,
		...
		if (playerentity != null) {
			...
			if (itemstack.getItem() != DoomItems.SSG.get()) {
				i = -i;
			}

			float f = playerentity.getAttackAnim(p_225623_3_);
			float f1 = MathHelper.sin(MathHelper.sqrt(f) * (float) Math.PI);
			float f2 = MathHelper.lerp(p_225623_3_, playerentity.yBodyRotO, playerentity.yBodyRot)
					* ((float) Math.PI / 180F);
			...
			if ((this.entityRenderDispatcher.options == null
				...
				vector3d = vector3d.xRot(-MathHelper.lerp(p_225623_3_, playerentity.xRotO, playerentity.xRot)
						* ((float) Math.PI / 180F));
				vector3d = vector3d.yRot(-MathHelper.lerp(p_225623_3_, playerentity.yRotO, playerentity.yRot)
						* ((float) Math.PI / 180F));
				...
				d5 = playerentity.yo + (double) playerentity.getEyeHeight()
						+ (playerentity.getY() - playerentity.yo) * (double) p_225623_3_ - 0.45D;
	...
	private static void vertex(IVertexBuilder p_229106_0_, Matrix4f p_229106_1_, Matrix3f p_229106_2_, int p_229106_3_,
			float p_229106_4_, int p_229106_5_, int p_229106_6_, int p_229106_7_) {
		p_229106_0_.vertex(p_229106_1_, p_229106_4_ - 0.5F, (float) p_229106_5_ - 0.5F, 0.0F).color(255, 255, 255, 255)
				.uv((float) p_229106_6_, (float) p_229106_7_).overlayCoords(OverlayTexture.NO_OVERLAY).uv2(p_229106_3_)
				.normal(p_229106_2_, 0.0F, 1.0F, 0.0F).endVertex();
	}

	private static void stringVertex(float p_229104_0_, float p_229104_1_, float p_229104_2_,
			IVertexBuilder p_229104_3_, Matrix4f p_229104_4_, float p_229104_5_) {
		p_229104_3_.vertex(p_229104_4_, p_229104_0_ * p_229104_5_,
				p_229104_1_ * (p_229104_5_ * p_229104_5_ + p_229104_5_) * 0.5F + 0.25F, p_229104_2_ * p_229104_5_)
				.color(0, 0, 0, 255).endVertex();
	}

	public ResourceLocation getTextureLocation(HookEntity p_110775_1_) {
