...
public class DoomBlocks {
	...
	public static final RegistryObject<Block> BARREL_BLOCK = BLOCKS.register("barrel",
			() -> new BarrelBlock((AbstractBlock.Properties.of(Material.EXPLOSIVE).instabreak()
	...
	public static final RegistryObject<Block> DOOM_SAND = BLOCKS.register("doom_sand", () -> new DoomSandBlock(
			(Block.Properties.of(Material.HEAVY_METAL).strength(4.0F).sound(SoundType.STONE))));
	...
	public static final RegistryObject<Block> E1M1_11 = BLOCKS.register("e1m1_block11", () -> new E1M1TurnableHurtBlock(
			(AbstractBlock.Properties.of(Material.HEAVY_METAL).strength(4.0F))));
