...
public class EntityDefaults {
	...
	public enum EntityConfigType {
		...
		ARACHNOTRON("Arachnotron", new EntityDefaults(false, 4, 100).setMeleeDamage(8).setRangedDamage(10).setGeneralSpeed(0.25)),
		ARCHVILE("Archvile", new EntityDefaults(true, 2, 100).setMeleeDamage(7).setGeneralSpeed(0.25)),
		BARON("Baron", new EntityDefaults(true, 1, 180).setMeleeDamage(15).setGeneralSpeed(0.25).setRangedDamage(12)),
		...
		CYBER_DEMON_2016("Cyber Demon 2016", new EntityDefaults(true, 1, 300).setMeleeDamage(15).setGeneralSpeed(0.25).setRangedDamage(18)),
		CYBER_DEMON("Cyber Demon", new EntityDefaults(true, 1, 300).setMeleeDamage(15).setGeneralSpeed(0.25).setRangedDamage(18)),
		...
		IMP_2016("Imp 2016", new EntityDefaults(false, 4, 30).setRangedDamage(8).setMeleeDamage(4).setGeneralSpeed(0.25)),
		IMP("Imp", new EntityDefaults(false, 4, 30).setRangedDamage(8).setMeleeDamage(4).setGeneralSpeed(0.25)),
		LOST_SOUL("Lost Soul", new EntityDefaults(false, 4, 10).setMeleeDamage(1).setGeneralSpeed(0.25)),
		MANCUBUS("Mancubus", new EntityDefaults(true, 1, 80).setMeleeDamage(8).setRangedDamage(13).setGeneralSpeed(0.25)),
		...
		REVENANT("Revenant", new EntityDefaults (true, 1, 20).setMeleeDamage(6).setRangedDamage(10).setGeneralSpeed(0.25)),
		SHOTGUN_GUY("Shotgun Guy", new EntityDefaults(false, 4, 15).setMeleeDamage(4).setRangedDamage(4).setGeneralSpeed(0.25)),
		SPIDER_DEMON("Spider Demon", new EntityDefaults(true, 1, 300).setRangedDamage(15).setMeleeDamage(8).setGeneralSpeed(0.25)),
