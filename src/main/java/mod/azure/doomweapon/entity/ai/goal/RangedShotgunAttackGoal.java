...
public class RangedShotgunAttackGoal<T extends MonsterEntity & IRangedAttackMob> extends Goal {
	...
	protected boolean isSGInMainhand() {
		return this.entity.getHeldItemMainhand().getItem() instanceof Shotgun
				|| this.entity.getHeldItemOffhand().getItem() instanceof Shotgun;
	}
	...
	public void tick() {
		...
		if (livingentity != null) {
			...
			if (this.entity.isHandActive()) {
				...
				this.entity.setActiveHand(ProjectileHelper.getHandWith(this.entity, DoomItems.SG.get()));
			}
