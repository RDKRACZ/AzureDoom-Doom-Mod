...
public class PossessedSoldierEntity extends DemonEntity {
	...
	protected void registerGoals() {
		...
		this.goalSelector.addGoal(7, new PossessedSoldierEntity.FireballAttackGoal(this));
	...
	static class FireballAttackGoal extends Goal {
		private final PossessedSoldierEntity parentEntity;
		public int attackTimer;

		public FireballAttackGoal(PossessedSoldierEntity ghast) {
		...
		public void tick() {
			...
			if (livingentity.getDistanceSq(this.parentEntity) < 4096.0D
				...
				if (this.attackTimer == 20) {
					...
					BulletMobEntity fireballentity = new BulletMobEntity(world, this.parentEntity, d2, d3, d4);
