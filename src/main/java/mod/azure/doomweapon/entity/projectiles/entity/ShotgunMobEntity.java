...
public class ShotgunMobEntity extends DamagingProjectileEntity {
	...
	protected void onImpact(RayTraceResult result) {
		...
		this.playSound(ModSoundEvents.SHOTGUN_SHOOT.get(), 1.0F, 1.2F / (this.rand.nextFloat() * 0.2F + 0.9F));
	}

	protected void explode() {
		this.world.createExplosion(this, this.getPosX(), this.getPosYHeight(0.0625D), this.getPosZ(), 0.3F,
				Explosion.Mode.NONE);
	}
