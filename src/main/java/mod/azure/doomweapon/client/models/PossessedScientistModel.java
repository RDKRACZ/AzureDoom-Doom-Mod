...
public class PossessedScientistModel<T extends PossessedScientistEntity> extends BipedModel<T> {
	...
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
		...
		this.bipedRightArm_flat.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F) * 1.4F * limbSwingAmount / 1.0F;
	...
	public void translateHand(HandSide sideIn, MatrixStack matrixStackIn) {
		...
		matrixStackIn.translate(-0.4D, -0.2D, 0.1D);
