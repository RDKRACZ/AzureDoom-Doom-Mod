...
public class PinkyModel<T extends Entity> extends EntityModel<T> {
	...
	public PinkyModel() {
		...
		this.pinkyBody_1.addBox(-2.1F, -10.3F, -8.8F, 5.0F, 5.0F, 5.0F, -8.0F, -5.0F, -6.0F);
		...
		this.pinkyArmR_1.addBox(-10.0F, -11.9F, 7.8F, 6.0F, 14.0F, 6.0F, -0.1F, 0.0F, -0.1F);
		...
		this.pinkyBody.addBox(-7.9F, -11.0F, -15.5F, 16.0F, 14.0F, 26.0F, 0.0F, -1.8F, -5.0F);
		...
		this.pinkyArmL_1.addBox(4.0F, -12.0F, 7.8F, 6.0F, 14.0F, 6.0F, -0.1F, 0.0F, -0.1F);
	...
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
		...
		this.pinkyLegR.rotateAngleX = MathHelper.cos(limbSwing) * 0.4F * limbSwingAmount;
		this.pinkyLegL.rotateAngleX = MathHelper.cos(limbSwing + (float) Math.PI) * 0.4F * limbSwingAmount;
	}
