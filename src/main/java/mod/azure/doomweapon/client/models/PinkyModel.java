...
public class PinkyModel<T extends Entity> extends EntityModel<T> {
	...
	public PinkyModel() {
        ...
        this.setRotateAngle(rLeg3, -0.8651597048872669F, 0.0911061832922575F, 0.0F);
        ...
        this.setRotateAngle(lLeg3, -0.8651597048872669F, -0.0911061832922575F, 0.0F);
        ...
        this.setRotateAngle(lLeg2, 0.956091342937205F, 0.0F, 0.2275909337942703F);
        ...
        this.setRotateAngle(rLeg2, 0.956091342937205F, 0.0F, -0.2275909337942703F);
        ...
        this.setRotateAngle(lLeg1, -0.6646214111173737F, 0.0F, -0.18203784630933073F);
        ...
        this.setRotateAngle(rLeg1, -0.6646214111173737F, 0.0F, 0.19547687289441354F);
	...
	public void setRotationAngles(T entityIn, float limbSwing, float limbSwingAmount, float ageInTicks,
		...
		//ModelHelper.func_239105_a_(this.lLeg1, this.rLeg1, false, this.swingProgress, ageInTicks);
		...
		this.lShoulder.rotateAngleX = MathHelper.cos(limbSwing * 0.6662F + (float) Math.PI) * 1.4F * limbSwingAmount / 1.0F;
