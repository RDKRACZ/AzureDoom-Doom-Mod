package mod.azure.doomweapon.client.render.projectiles.entity;
...
public class RocketMobRender extends EntityRenderer<RocketMobEntity> {
	...
	@Override
	public ResourceLocation getEntityTexture(RocketMobEntity entity) {
	...
	public void render(RocketMobEntity entityIn, float entityYaw, float partialTicks, MatrixStack matrixStackIn,
