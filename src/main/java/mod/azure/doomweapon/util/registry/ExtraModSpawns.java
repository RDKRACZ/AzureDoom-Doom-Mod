...
public class ExtraModSpawns {
	...
	public static void registerEntityModWorldSpawns() {
		registerEntityWorldSpawn(ModEntityTypes.IMP.get(), 30, 1, 4, NetherBiomes.BASALT_DELTAS.get(),
		...
		registerEntityWorldSpawn(ModEntityTypes.ARCHVILE.get(), 4, 1, 2, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		registerEntityWorldSpawn(ModEntityTypes.BARON.get(), 10, 1, 1, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		registerEntityWorldSpawn(ModEntityTypes.MANCUBUS.get(), 10, 1, 1, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		registerEntityWorldSpawn(ModEntityTypes.REVENANT.get(), 10, 1, 1, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		registerEntityWorldSpawn(ModEntityTypes.SPIDERDEMON.get(), 10, 1, 1, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		...
		registerEntityWorldSpawn(ModEntityTypes.IMP2016.get(), 30, 1, 4, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		registerEntityWorldSpawn(ModEntityTypes.CHAINGUNNER.get(), 30, 1, 4, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		registerEntityWorldSpawn(ModEntityTypes.SHOTGUNGUY.get(), 30, 1, 4, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		registerEntityWorldSpawn(ModEntityTypes.MARAUDER.get(), 15, 1, 1, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		...
		registerEntityWorldSpawn(ModEntityTypes.CYBERDEMON.get(), 10, 1, 1, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		registerEntityWorldSpawn(ModEntityTypes.UNWILLING.get(), 30, 1, 4, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		registerEntityWorldSpawn(ModEntityTypes.POSSESSEDSCIENTIST.get(), 30, 1, 4, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
		registerEntityWorldSpawn(ModEntityTypes.POSSESSEDSOLDIER.get(), 30, 1, 4, NetherBiomes.BASALT_DELTAS.get(),
				NetherBiomes.CRIMSON_FOREST.get(), NetherBiomes.SOUL_SAND_VALLEY.get(),
				NetherBiomes.WARPED_FOREST.get());
