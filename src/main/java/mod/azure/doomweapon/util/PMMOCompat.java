...
//		XP.awardXpTrigger(player, "doomweapon.consume.inmortal", null, true, true);
	}

	public static void awardInvisibleXp(ServerPlayerEntity player) {
//		XP.awardXpTrigger(player, "doomweapon.consume.invisible", null, true, true);
	}

	public static void awardMegaXp(ServerPlayerEntity player) {
//		XP.awardXpTrigger(player, "doomweapon.consume.mega", null, true, true);
	}

	public static void awardPowerXp(ServerPlayerEntity player) {
//		XP.awardXpTrigger(player, "doomweapon.consume.power", null, true, true);
	}

	public static void awardSoulXp(ServerPlayerEntity player) {
//		XP.awardXpTrigger(player, "doomweapon.consume.soul", null, true, true);
	}
